package com.zhangke.simpleimageloader;
...
import com.zhangke.imageloader.cache.DoubleCache;
            ...
            case 1:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                        ...
                        imageLoader = SimpleImageLoader.init(new ImageLoaderConfig.Builder()
                                .setBitmapCache(new DoubleCache(MainActivity.this)).build());
